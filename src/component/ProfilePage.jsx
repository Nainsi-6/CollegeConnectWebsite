...
//     try {
//       const response = await fetch(`http://localhost:5005/api/posts/user/${targetUserId}/count`)
//       if (response.ok) {
...
const ProfilePage = () => {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-screen bg-gray-50">
        <div className="animate-spin rounded-full h-8 w-8 lg:h-12 lg:w-12 border-b-2 border-indigo-600"></div>
        <p className="ml-4 text-indigo-700 text-sm lg:text-lg">Loading profile...</p>
      </div>
    )
  }
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 px-4">
        <p className="text-lg lg:text-xl text-red-600 font-semibold text-center">{error}</p>
        <button
          onClick={handleGoBack}
          className="mt-4 px-4 lg:px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md shadow text-sm lg:text-base"
        >
          ← Go Back
        </button>
      </div>
  ...
  if (!profile) {
    return (
      <div className="text-center py-10 px-4 bg-gray-50">
        <p className="text-base lg:text-lg text-gray-600">Profile not found</p>
        <button
          onClick={handleGoBack}
          className="mt-4 px-4 lg:px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md text-sm lg:text-base"
        >
          ← Go Back
        </button>
      </div>
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center px-4 lg:px-6 py-4 bg-white shadow-sm border-b gap-3 sm:gap-0">
        <button
          onClick={handleGoBack}
          className="px-3 lg:px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md text-sm lg:text-base"
        >
          ← Back
        </button>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 w-full sm:w-auto">
          <button
            onClick={handleViewPosts}
            className="flex items-center gap-2 px-3 lg:px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md shadow text-sm lg:text-base w-full sm:w-auto justify-center"
          >
          ...
          {!userId && (
            <button
              onClick={() => setShowSavedPosts(true)}
              className="flex items-center gap-2 px-3 lg:px-4 py-2 border border-blue-200 text-blue-600 hover:bg-blue-50 rounded-md shadow transition-colors text-sm lg:text-base w-full sm:w-auto justify-center"
            >
...
const GenericProfileDetails = ({ profile, postCount }) => (
  <div className="bg-white rounded-lg shadow p-4 lg:p-6">
    <h2 className="text-lg lg:text-xl font-semibold mb-4 text-gray-800">Profile Details</h2>
